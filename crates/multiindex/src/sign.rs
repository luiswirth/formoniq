//! The sign group ${plus.minus 1}$, and the parity of a reordering.

/// An element of the sign group ${plus.minus 1}$.
///
/// The value a reordering carries on an alternating structure: the sign of a
/// permutation, of a signed merge, of a complement. Multiplication is the group
/// law, so it composes.
...
impl Sign {
  ...
  /// The sign a reordering of this many inversions carries, $(-1)^n$.
