...
- Metric-free operations: the wedge product, the interior product (contraction,
  ...
  minors.
- Metric operations, entering only through a `RiemannianMetric`: induced inner
...
adjointness of pullback and pushforward, the Hodge involution ⋆⋆ = (−1)^(k(n−k)),
the antiderivation identity for the interior product, and the musicals as mutual
inverses.
